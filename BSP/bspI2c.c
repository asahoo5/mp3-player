 ...
 */
void I2C_start(I2C_TypeDef* I2Cx, uint8_t address, uint32_t direction, uint32_t request, uint8_t nBytes){
  BspI2c_WaitWithTimeoutReset(LL_I2C_IsActiveFlag_BUSY, 0);
  LL_I2C_HandleTransfer(I2Cx, address, LL_I2C_ADDRSLAVE_7BIT, (uint32_t)nBytes, request, direction);  //LL_I2C_MODE_AUTOEND
}
